  ...
  if (loading && sessions.length === 0) {
    return (
      <div className="min-h-screen bg-[#020617] flex flex-col items-center justify-center space-y-4">
        ...
        <p className="text-primary font-black tracking-widest animate-pulse uppercase text-xs">Sincronizando Arena...</p>
      </div>
    );
  }
          ...
          {activeTab === 'cancha' && (
            <motion.div key="cancha" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6">
                <div className="bg-card rounded-[2rem] border border-border p-4 shadow-sm flex items-center justify-center">
